...
rnms <- c("DOI", "feature", "observer", "plot_res", "n_sites", "t_btwn_samp",
          "study_duration")
...
calr[feature != 99, lapply(.SD, CV), by = .(DOI, feature), 
     .SDcols = rnms[4:7]][, lapply(.SD, mean, na.rm = TRUE), 
                          .SDcols = rnms[4:7]]
...
Others need to fix their study duration figures. Paul on paleo one in calibration, Choi, Chang, etc in main set.  [Ahmed remaining]
