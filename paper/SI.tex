...
The following text provides additional information on this study's Methods and Results.  The full manuscript, data, and code used to analyze the data are available on an accompanying github repository (https://github.com/ecohydro/ecoscales). \textbf{Note to editors and reviewers: this repository is currently private, but will be transitioned to a public repository upon acceptance of manuscript.}
