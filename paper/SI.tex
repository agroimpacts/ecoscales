...
The following text provides additional information on this study's Methods and Results.  The full manuscript, data, and code are available on an accompanying \href{https://github.com/ecohydro/ecoscales}{github repository}. \textbf{Note to editors and reviewers: this repository is currently private, but will be made public upon acceptance of manuscript. In the interim, the code and data can be downloaded from the following links}:
\href{https://www.dropbox.com/s/4r9h8mn1wa4kjsn/calibration.html?dl=0}{Calibration analysis}; \href{https://www.dropbox.com/s/n0zq5zufu96ktfl/calibration-set.xlsx?dl=0
}{Calibration dataset}; \href{https://www.dropbox.com/s/bzni8dhqy8un4fz/space-time.html?dl=0
}{Main analysis}; \href{https://www.dropbox.com/s/vujjo2x4f5kwqkb/main-results.xlsx?dl=0
}{Main dataset}
...
Fig. \ref{obshists} details the distributions of observations by method along the four primary dimensions, while Fig. \ref{obskde} reveals the densities of observations by method within the dimensional juxtapositions shown in Fig. 2 in the main text. 

\begin{figure}[!ht]
%\begin{wrapfigure}{c}{1\textwidth}
\includegraphics[width=1\textwidth]{../vignettes/figures/fig1s.png}
\vspace{-20 pt}
...
\vspace{-10pt}
Figures \ref{type_by_yr} and \ref{sc_by_yr} respectively show how the frequency of ecological observing methods and the average scale in each dimensions varies by publication year (2004-2014). 
...
\begin{figure}[!ht]
%\begin{wrapfigure}{c}{1\textwidth}
\includegraphics[width=0.9\textwidth]{../vignettes/figures/res_v_extent_ksize2.png}
\vspace{10 pt}
